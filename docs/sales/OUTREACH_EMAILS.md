# Outreach Emails — 50-Touch Validation Sprint

Rules: 5–10/day, every one personalized with a ⟨specific observation⟩ (their portfolio, a
...
> ⟨Name⟩ — I came across ⟨Company⟩ via ⟨specific: the Belmont kitchen on your site / your sign
> on Rio Rd / a glowing review mentioning ⟨detail⟩⟩.
>
...
**A2 (day 4) — Subject: `re: proposals at ⟨Company⟩`**
...
**A3 (day 10, final) — Subject: `closing the loop`**

> ⟨Name⟩ — last note from me. I'm capping founding audits at five Charlottesville businesses at
> $950 (then $1,250), and ⟨n⟩ slots remain. If the timing's wrong, no response needed — but if
> proposals, follow-up, or being your team's answer desk is costing you evenings, the
> application takes five minutes: ⟨site⟩/apply
>
> Good building either way. — Ben

## Sequence B — warm-ish (met once / mutual connection)
...
>
> Free 20-minute fit call to see if it's worth it? If it isn't, I'll say so on the call.

## Sequence C — premium home services / property mgmt (secondary ICP)

**C1 — Subject: `the 11-day-old inquiry`**

> ⟨Name⟩ — here's the pattern I keep finding in ⟨trade⟩ businesses: an inquiry comes in, isn't
> ready to buy, gets one reply… and never hears from you again. Eleven days later they've hired
...
## LinkedIn DM (connector/peer version)

> Launched my Charlottesville AI advisory practice — paid operating audits for owner-led
> businesses (design/build first). Capped at 5 founding clients at $950. Not asking you to buy:
> asking who's the one owner you know who's drowning in proposals and interruptions? Intro
> appreciated; I'll do the rest.

## Tracking the sprint

Targets: 50 sends → 10–12 calls → 3 paid audits → $2,850+ → ≥1 implementation proposal.
Tally weekly in `/admin` (pipeline header shows the goal). If 25 sends produce <3 calls, change
the ⟨specific observation⟩ quality before changing the template.
