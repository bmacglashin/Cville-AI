...
const GROUPS: { heading: string; links: { href: string; label: string }[] }[] = [
  {
    ...
    links: [
      ...
      { href: "/command-center", label: "Command Center Lite (post-audit)" },
      ...
      <div className="mx-auto w-full max-w-6xl px-5 py-14 sm:px-8">
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-border pt-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          ...
          <p className="max-w-md leading-relaxed">
            We do not work with regulated data (health, student, lending, legal) in current
            engagements, and we never deploy AI that acts without human review.
          </p>
        </div>
      </div>
    </footer>
